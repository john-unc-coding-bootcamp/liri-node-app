...
if (needInfo === "my-tweets")  {
  ...
  client.get('statuses/user_timeline', params, function(error,tweets,response){
    if (error) {
      // best practices would say to handle this error and notify the user something went wrong
      // but this is not a requirement for the assigment 
      console.log("Something went wrong! " + error);
    } else {
      // you can use a for loop here since it is a way to initialize i and increment it in one line
      // Since we start at 0, saying `i < 20` should give us 20 tweets (it will cycle through 0-19)
      for (var i=0; i < 20; i++) {
         if (tweets[i] != null)  {
